const Team = [
  { name:'Kevin Lawrence',
    ...
    { name:'Tyler Judd',
    title:'Project Manager / Solidworks',
    desc:'Tyler comes to us with a machine shop and drafting background.',
    photo:require('../Assets/Tyler.jpg')},

    { name:'Trevor Halbrook',
    title:'Sawyer / Fabricator',
    desc:'Trevor has stainless steel, aluminum and mild steel experience.',
    photo:require('../Assets/NoPhoto.jpg')},
